...
public class XSDUtil {
	...
	public static void getXsdAndSave(String URL, String dir, String name) throws IOException, ParserConfigurationException{
		String xsd = FileUtil.getFileAsString(URL);
		Document doc = FileUtil.convertStringToDocument(liniarizeXSD(xsd));
		...
		for(String schemaLocation : schemasLocation){
			getXsdAndSave(schemaLocation, dir, name.replace(".xsd", "_" +
					(schemasLocation.indexOf(schemaLocation) + 1) + ".xsd"));
		}
	}
...
//	}
	...
	public static List<String> getExternalSchemasLocations(Document doc, String url, String name) throws ParserConfigurationException{
		Element root = doc.getDocumentElement();
		return getExternalSchemasLocations(root, url, name);
	}
	
	public static List<String> getExternalSchemasLocations(Element root, String url, String name) throws ParserConfigurationException{
		List<String> schemas = new ArrayList<String>();
		getExternalSchemasLocations(root, schemas, url, name);
		return schemas;
	}
	
	private static void getExternalSchemasLocations(Element root, List<String> schemas, String url, String nameXSD) throws ParserConfigurationException{
